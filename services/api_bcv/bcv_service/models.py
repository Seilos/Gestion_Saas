...
class ExchangeRate(models.Model):
    ...
    class Meta:
        ...
        # Avoid saving identical dates from the same source multiple times if needed
        # unique_together = ('source', 'fecha_valor')

    def __str__(self):
        return f"{self.get_source_display()} - {self.value} VED ({self.fecha_valor})"
